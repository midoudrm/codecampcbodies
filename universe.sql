...
CREATE TABLE public.astronaut (
    ...
    nale character varying(50) NOT NULL,
    age integer,
...
ALTER SEQUENCE public.space_mission_mission_id_seq OWNED BY public.space_mission.mission_id;
...
--
-- Name: space_mission mission_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.space_mission ALTER COLUMN mission_id SET DEFAULT nextval('public.space_mission_mission_id_seq'::regclass);
...
SELECT pg_catalog.setval('public.space_mission_mission_id_seq', 1, false);
